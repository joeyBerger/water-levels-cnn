...
def get_train_cli_args():
    ...
    parser.add_argument('--arch_id', type=int, default=0,
                        help='Architecture ID to be used during training')
    parser.add_argument('--learning_rate', type=float, default=0.003,
                        help='Learning rate to be used during training')
    parser.add_argument('--hidden_units', type=int, default=256,
                        help='Number of hidden units to be used during training')
    parser.add_argument('--epochs', type=int, default=1,
                        help='Number of epochs to be used during training')
    parser.add_argument('--enable_gpu', type=int, default=1,
                        help='Whether to use GPU during training. Valid inputs are 0 or 1')
...
def get_predict_cli_args():
    ...
    parser.add_argument('--category_names', type=str,
                        default='cat_to_name.json', help='Path to the classifier names')
    parser.add_argument('--top_k', type=int, default=-1,
                        help='Amount of most likely classes to display')
    parser.add_argument('--enable_gpu', type=int, default=1,
                        help='Whether to use GPU during training. Valid inputs are 0 or 1')
